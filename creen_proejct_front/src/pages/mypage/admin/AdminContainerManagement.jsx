...
const AdminContainerManagement = () => {
  ...
  const finalValue = co2Value.replace('g', '');
  // 버튼 누를 때 작동
    ...
    <div>
          ...
          <div className={styles.attached_container}>
            <div className={styles.attached_left}>
              ...
              <div className={styles.attached_text}>
                ...
                <span className={styles.attached_size}>{fileName} | {formatBytes(fileSize)}</span>
              </div>
            </div>
      ...
      <section className={styles.input_two}>
        <div className={styles.item_name_input}>
          <p>용기 이름</p>
          <input type='text' placeholder="ex) 사각 용기(소)" className={styles.item_name}></input>
        </div>
        ...
        <div className={styles.co2_value_input}>
          ...
          <div className={styles.input_wrapper}>
            ...
            {co2Value && <span className={styles.unit}>g</span>}
          </div>
        </div>
      </section>
